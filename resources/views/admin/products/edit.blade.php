                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li></li><a href="{{ route('admin.products.create') }}"><i class="fa fa-dashboard"></i> Create</a></li>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control ckeditor" name="specification" id="specification" rows="5" placeholder="Specification">{!! $product->specification  !!}</textarea>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                @foreach($images as $image)
                                                    <div class="col-md-3">
                                                        <div class="row">
                                                            <img src="{{ asset("uploads/$image->src") }}" alt="" class="img-responsive"> <br />
