    ...
    <section class="content">
        ...
        <div class="box">
            <ol class="breadcrumb">
                ...
                <li><a href="{{url('/admin/addresses') }}"><i class="fa fa-dashboard"></i> Addresses</a></li>
            ...
            <form action="{{ route('admin.addresses.update', $address->id) }}" method="post" class="form" enctype="multipart/form-data">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="phone_no" id="phone_no" placeholder="Phone Number" class="form-control" value="{{ $address->phone_no ?: old('phone_no') }}">
                    </div>
