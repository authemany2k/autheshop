                                ...
                                <td>
                                    <a href="{{ route('front.get.product', [$cartItem->product->slug]) }}" class="hover-border">
                                        @if(isset($cartItem->cover))
                                            <img src="{{ asset("uploads/$cartItem->cover") }}" alt="{{ $cartItem->name }}" class="img-responsive img-thumbnail">
                                        @else
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="btn-group pull-right">
                                <a href="{{ url('clearCart') }}" class="btn btn-sm btn-flat btn-danger" onclick="return confirm('Are you sure you want to clear the cart?')"><span class="fa fa-trash-o" aria-hidden="true"></span> Empty Cart</a>
                                <a href="{{ url('category/new-arrivals') }}" class="btn btn-sm btn-flat btn-default">Continue shopping</a>
                                {{--<a href="{{ route('home') }}" class="btn btn-sm btn-flat btn-default">Continue shopping</a>--}}
                                <a href="{{ route('checkout.index') }}" class="btn btn-sm btn-flat btn-primary">Go to checkout</a>
                            </div>
                        </div>
                    </div>
                </div>
