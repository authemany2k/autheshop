...
@section('content')
    ...
    <section class="container content">
        ...
        <div class="box">
            <form action="{{ url('customer/'.$address->id.'/address/'. $customer->id.'/') }}" method="post" class="form" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="phone_no" id="phone_no" placeholder="phone_no" class="form-control" value="{{$address->phone_no ?: old('phone_no') }}">
                    </div>
