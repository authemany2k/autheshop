...
namespace App\Shop\PaymentMethods\Paystack;
...
class PaystackRepository
{
    ...
    /**
     * PaystackRepository constructor.
     ...
     * @return Charge Paystack charge object
     * @throws PaystackChargingErrorException
     */
    public function execute(array $data, $total, $tax) : Charge
    {
        try {
            ...
            throw new PaystackChargingErrorException($e);
        }
    }
}
